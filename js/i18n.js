...
(function () {
  ...
  const STRINGS = {
    en: {
      nav_tools: "Tools", nav_propfirms: "Prop Firms", nav_community: "Community", nav_signin: "Sign In", nav_create: "Get Started",
      hero_eyebrow: "Independent trading toolkit",
      hero_h1_1: "Smarter tools.", hero_h1_2: "Better trading decisions.",
      hero_sub: "Calculate position size, manage risk, track global forex sessions and compare prop firms from one simple toolkit.",
      hero_cta_primary: "Explore Free Tools", hero_cta_secondary: "Compare Prop Firms",
      hero_trust: "Free to use", hero_trust_2: "No signup required",
      preview_label: "Lot size calculator", preview_result_label: "Calculated position size",
      preview_risk: "Risk per trade", preview_session: "London · NY overlap", preview_lot: "Position size",
      tools_eyebrow: "Core tools", tools_h2: "Everything you need to manage your trades.", tools_sub: "Three essential tools. No unnecessary complexity.",
      ...
      sessions_title: "Trading Sessions", sessions_desc: "See which major forex sessions are open in real time.", sessions_cta: "View Live Sessions",
      propfirms_home_h2: "Find the right prop firm.", propfirms_home_desc: "Compare the rules that matter before purchasing a challenge.", propfirms_home_cta: "Compare Prop Firms",
      community_h2: "Trade smarter. Together.",
      community_text: "Join the MyForexKit community to discuss trading, risk management, prop firms and new MyForexKit tools with other traders.",
      community_cta: "Join the Community",
      final_h2: "Your trading toolkit starts here.", final_cta_2: "Join the Community",
      ...
      sessions_your_time: "Your time", sessions_utc: "UTC",
    ...
    fr: {
      nav_tools: "Outils", nav_propfirms: "Prop Firms", nav_community: "Communauté", nav_signin: "Connexion", nav_create: "Créer un compte",
      hero_eyebrow: "Boîte à outils de trading indépendante",
      hero_h1_1: "Des outils plus intelligents.", hero_h1_2: "De meilleures décisions de trading.",
      hero_sub: "Calculez la taille de position, gérez le risque, suivez les sessions forex mondiales et comparez les prop firms — le tout dans une seule boîte à outils simple.",
      hero_cta_primary: "Découvrir les outils", hero_cta_secondary: "Comparer les prop firms",
      hero_trust: "Gratuit", hero_trust_2: "Sans inscription",
      preview_label: "Calculateur de taille de lot", preview_result_label: "Taille de position calculée",
      preview_risk: "Risque par trade", preview_session: "Chevauchement Londres · NY", preview_lot: "Taille de position",
      tools_eyebrow: "Outils essentiels", tools_h2: "Tout ce qu'il faut pour gérer vos trades.", tools_sub: "Trois outils essentiels. Aucune complexité inutile.",
      lot_title: "Calculateur de taille de position", lot_desc: "Calculez la taille de position selon le solde, le risque et le stop loss.", lot_cta: "Calculer la taille de lot",
      ...
      sessions_title: "Sessions de trading", sessions_desc: "Voyez quelles sessions forex majeures sont ouvertes en temps réel.", sessions_cta: "Voir les sessions en direct",
      propfirms_home_h2: "Trouvez la bonne prop firm.", propfirms_home_desc: "Comparez les règles qui comptent avant d'acheter un challenge.", propfirms_home_cta: "Comparer les prop firms",
      community_h2: "Progressez ensemble.",
      community_text: "Rejoignez la communauté MyForexKit pour échanger sur le trading, la gestion du risque, les prop firms et les nouveaux outils MyForexKit.",
      community_cta: "Rejoindre la communauté",
      final_h2: "Votre boîte à outils de trading commence ici.", final_cta_2: "Rejoindre la communauté",
      ...
      sessions_your_time: "Votre heure", sessions_utc: "UTC",
      sessions_open: "OUVERTE", sessions_closed: "FERMÉE",
